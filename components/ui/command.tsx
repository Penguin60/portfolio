...
>(({ className, ...props }, ref) => (
  <CommandPrimitive
    ref={ref}
    className={cn(
      "flex h-full w-full flex-col overflow-hidden rounded-md bg-zinc-50 text-zinc-950 dark:bg-zinc-950 dark:text-zinc-50",
      className
    )}
    {...props}
  />
...
>(({ className, showBorder = true, ...props }, ref) => (
  <div
    className={cn("flex items-center", showBorder && "border-b", className)}
    cmdk-input-wrapper=""
  >
