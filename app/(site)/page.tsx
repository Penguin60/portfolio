...
export default async function Home() {
  ...
  return (
    <main className="text-black dark:text-white items-start flex justify-start mt-3 pb-12 sm:pb-0">
      <div id="card" className="w-full flex mx-4">
        <div className="flex flex-col w-full h-full">
          <div className="sm:flex sm:items-start sm:gap-6">
            ...
            <div className="sm:flex-1 sm:order-1">
              <p className="text-sm">
                I&apos;m an 11th grade IB student interested in programming,
                robotics and design.
              </p>
              <p className="mt-2 text-sm">
                I love learning, experimenting and seeing the things I build
                come to life!
              </p>
              ...
              <ul className="mt-2 space-y-1 text-sm list-disc list-inside marker:text-zinc-400">
                <li>
                  swe intern @
                  <a
                    href="https://sorsys.ca/en"
                    className="font-medium underline underline-offset-4"
                  >
                    sorsys
                  </a>
                  , working on machine analytics
                </li>
                <li>
                  web/tech lead @
                  <a
